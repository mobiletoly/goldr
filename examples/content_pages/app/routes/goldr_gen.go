...
//   layout  -         /privacy  privacy/layout.go
...
import (
	...
	"github.com/mobiletoly/goldr/examples/content_pages/app/internal/goldrinspect"
	goldrroute_about "github.com/mobiletoly/goldr/examples/content_pages/app/routes/about"
	goldrroute_privacy "github.com/mobiletoly/goldr/examples/content_pages/app/routes/privacy"
)
...
var goldrGeneratedManifest = goldrManifest{
	...
	Layouts: []goldrLayout{
		...
		},
		{
			...
			Params:      nil,
			Unit: goldrRenderUnit{
				GoFile:    "privacy/layout.go",
				TemplFile: "privacy/layout.templ",
			},
		},
	},
	Fragments: []goldrFragment{},
...
var goldrLayoutStack1 = []goldrLayoutStep{
	...
	// expected in file: app/routes/privacy/layout.go
	{
		render: goldrroute_privacy.Layout,
		marker: goldrinspect.NewMarker("g_layoutprivacy_layout_templ", "layout", "/privacy", "app/routes/privacy/layout.templ", "app/routes/privacy/layout.go"),
	},
}
...
func goldrMiddlewareStack0(next http.Handler) http.Handler {
	// expected in file: app/routes/privacy/middleware.go
	next = goldrroute_privacy.Middleware(next)
	return next
}
...
func goldrAdditionalPageHandler(handlers *goldrAdditionalPageHandlers, routePath string) http.Handler {
	if routePath == "/privacy" || strings.HasPrefix(routePath, "/privacy/") {
