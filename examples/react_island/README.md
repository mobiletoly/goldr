...
This example mounts one React 19 editor inside a Goldr page. Goldr owns the
page shell, filesystem routes, Save endpoint, CSRF, navigation, and assets.
React owns only the descendants of the explicit editor root.
...
is an ordinary link enhanced by HTMX. The app-owned bridge unmounts React before
HTMX replaces the page and mounts a fresh editor after Back navigation.
