...
import (
	...
	clicheck "github.com/mobiletoly/goldr/cmd/goldr/internal/goldrcli/check"
	clidev "github.com/mobiletoly/goldr/cmd/goldr/internal/goldrcli/dev"
	cligenerate "github.com/mobiletoly/goldr/cmd/goldr/internal/goldrcli/generate"
	cliinit "github.com/mobiletoly/goldr/cmd/goldr/internal/goldrcli/initcmd"
	"github.com/mobiletoly/goldr/cmd/goldr/internal/goldrcli/routes"
...
const rootDescription = `Goldr apps keep live route source under app/routes, optional mounted route surfaces under app/mounts, and generate ordinary Go files for route dispatch and URL helpers.
