...
- `github.com/mobiletoly/goldr`: route responses, pages, fragments, layouts,
  generated handler options, template inspection, and HTML writing helpers.
...
3. Inspect the app's current structure before editing:
   - `app/routes`
   - app server setup
...
5. Do not hand-edit generated files. Regenerate them.
6. Run focused validation, then broader validation when the change crosses
   package or browser-visible boundaries.
7. Stop any dev server you start.
